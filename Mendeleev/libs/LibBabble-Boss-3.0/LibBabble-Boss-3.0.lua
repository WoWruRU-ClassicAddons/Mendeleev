...
local MINOR_VERSION = 90000 + tonumber(string.match("$Rev: 190 $", "%d+"))
...
elseif GAME_LOCALE == "zhTW" then
	...
	Firemaw = "費爾默",
	Flamegor = "弗萊格爾",
	["Flame Leviathan"] = "烈焰巨獸", -- Needs review
	...
	["The Iron Council"] = "鋼鐵議會", -- Needs review
	...
	Wushoolay = "烏蘇雷",
	Xevozz = "基沃滋",
	["XT-002 Deconstructor"] = "XT-002 破壞者", -- Needs review
	Ysondre = "伊索德雷",
	Zekkis = "澤基斯",
